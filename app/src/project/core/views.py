...
from .forms import SimulationHyperparametersForm, YumaParamsForm, SelectionForm

from yuma_simulation._internal.cases import cases as package_cases
from yuma_simulation._internal.yumas import YumaSimulationNames, SimulationHyperparameters, YumaParams
...
def simulation_view(request):
    ...
    if selection_form.is_valid() and hyper_form.is_valid() and yuma_form.is_valid():
        ...
        try:
            ...
            print(f"Generated Chart Table HTML: {chart_table_html}")
        except Exception as e:
            return HttpResponse(f"Error: {e}", status=500)
        
        # print(f"generated table{chart_table_html.data}")
